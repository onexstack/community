---
title: "Contributing to Zero"
weight: 4
description: |
  An entrypoint to getting started with contributing to the Zero project.
---
...
Zero is open source, but many of the people working on it do so as their day job.
